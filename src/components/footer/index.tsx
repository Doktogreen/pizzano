        ...
        <footer className="ftco-footer ftco-section img">
                ...
                <div className="col-lg-3 col-md-6 mb-5 mb-md-5">
                    <div className="ftco-footer-widget mb-4">
                        ...
                        <ul>
                            ...
                            <li><a href="..."><span className="icon icon-envelope"></span><span className="text">info@pizzano.com</span></a></li>
                        </ul>
                        </div>
                    </div>
                </div>
            ...
            <div className="row">
                <div className="col-md-12 text-center">
                    <p>
                        Copyright &copy; 15/02/2022 All rights reserved. Build by{" "}<i className="icon-heart" aria-hidden="true"></i> {" "}<a href="..." target="_blank">Pizzano</a>
                    </p>
                </div>
            </div>
        </div>
